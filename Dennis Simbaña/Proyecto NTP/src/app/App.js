    ...
    if(this.state._id) {
      fetch(`/api/task/${this.state._id}`, {
        ...
        .then(data => {
          ...
          this.setState({_id: '', title: '', descripcion: ''});
          this.fetchTasks();
        });
    } else {
      fetch('/api/task', {
        ...
        <nav className="light-blue darken-4">
          <div className="container">
            <div className="nav-wrapper">
              <a href="#" className="brand-logo">Reserva Hotel</a>
            </div>
          </div>
        </nav>
              ...
              <div className="card">
                <div className="card-content">
                  <form onSubmit={this.addTask}>
                    ...
                    <div className="row">
                      <div className="input-field col s12">
                        <textarea name="descripcion" onChange={this.handleChange} value={this.state.descripcion} cols="30" rows="10" placeholder="Task Description" className="materialize-textarea"></textarea>
                      </div>
                    </div>
